...
description: Use when user asks for Shared system context — archetypes, scoring, tools, writing style, ethical rules.
version: 1.0.0
...
# Career Ops Shared — Career-Ops for Hermes
...
| Recent layoff news | `web_search` | Medium | Must consider department, timing, and company size |
...
| Hermes browser tools | Verify offers (browser_navigate + browser_snapshot). **NEVER 2+ agents with Hermes browser tools in parallel.** |
