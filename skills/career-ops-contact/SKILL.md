...
description: Use when user asks for LinkedIn outreach — identify targets (recruiter, hiring manager, peer, interviewer), generate 3-sentence messages per contact type.
version: 1.0.0
...
# Career Ops Contact — Career-Ops for Hermes
