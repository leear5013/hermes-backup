...
description: Use when user asks for Rejection pattern detector — analyze application outcomes, identify conversion patterns per archetype/remote policy/score range, actionable recommendations.
version: 1.0.0
...
# Career Ops Patterns — Career-Ops for Hermes
