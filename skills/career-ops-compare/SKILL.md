...
description: Use when user asks for Multi-offer comparison with 10 weighted dimensions and ranked recommendations.
version: 1.0.0
...
# Career Ops Compare — Career-Ops for Hermes
