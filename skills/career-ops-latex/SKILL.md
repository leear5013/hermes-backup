...
description: Use when user asks for LaTeX/Overleaf CV export — generate .tex file, compile to PDF, Overleaf-compatible.
version: 1.0.0
...
# Career Ops Latex — Career-Ops for Hermes
