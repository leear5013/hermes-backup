...
description: Use when user asks for Full A-G job offer evaluation — role summary, CV match, level strategy, comp research, customization plan, interview prep, posting legitimacy check.
version: 1.0.0
...
# Career Ops Evaluate — Career-Ops for Hermes
...
**1. Posting Freshness** (from Hermes browser tools snapshot, already captured in Step 0):
