---
name: career-ops-pdf
description: Use when user asks for ATS-optimized PDF CV generation from HTML template — keyword injection, archetype adaptation, browser rendering.
version: 1.0.0
...
# Career Ops Pdf — Career-Ops for Hermes
