...
description: Use when user asks for Deep company research — 6-axis structured research prompt (AI strategy, recent moves, engineering culture, challenges, competitors, candidate angle).
version: 1.0.0
...
# Career Ops Deep — Career-Ops for Hermes
