...
description: Use when user asks for Company-specific interview intelligence — research, process overview, audience map, likely questions per audience, story bank mapping, technical prep checklist.
version: 1.0.0
...
# Career Ops Interview Prep — Career-Ops for Hermes
